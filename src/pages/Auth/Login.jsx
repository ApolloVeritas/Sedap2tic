    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                // Arahkan pengguna ke dashboard setelah login sukses
                navigate("/");
            } else {
    ...
    return (
        <div>
            ...
            <div className="mt-4 flex justify-between text-sm text-gray-600">
                <button onClick={() => navigate("/forgot")} className="text-blue-600 hover:text-blue-700">
                    Forgot Password?
                </button>
                <button onClick={() => navigate("/register")} className="text-blue-600 hover:text-blue-700">
                    Register
                </button>
            </div>
        </div>
